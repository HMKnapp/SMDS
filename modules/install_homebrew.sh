...
function _install {
  ...
  echo 'export PATH="$HOME/homebrew/bin:$PATH"' | tee -a $HOME/.zprofile $HOME/.bash_profile
  export PATH="$HOME/homebrew/bin:$PATH"
  echo 'export HOMEBREW_CASK_OPTS="--appdir=$HOME/Apps"' | tee -a $HOME/.zprofile $HOME/.bash_profile
